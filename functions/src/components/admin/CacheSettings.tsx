...
export function CacheSettings() {
  ...
  const getOfflineModeDescription = (mode: "auto" | "manual" | "disabled") => {
    switch (mode) {
      case "auto":
        return "Automatically handle offline scenarios and sync when online";
      case "manual":
        return "Require user confirmation for offline actions and sync";
      case "disabled":
        return "Disable offline functionality completely";
      default:
        return "";
    }
  };
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              placeholder="Select offline mode..."
            />
            <p className="text-xs text-muted-foreground">
              {getOfflineModeDescription(settings.offlineMode)}
            </p>
          </div>
        </CardContent>
      </Card>
